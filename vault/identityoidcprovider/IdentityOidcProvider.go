...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v15/identityoidcprovider/internal"
...
func (j *jsiiProxy_IdentityOidcProvider) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IdentityOidcProvider) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IdentityOidcProvider) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IdentityOidcProvider) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IdentityOidcProvider) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IdentityOidcProvider)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IdentityOidcProvider)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IdentityOidcProvider)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IdentityOidcProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IdentityOidcProvider) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityOidcProvider) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IdentityOidcProvider) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
