...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v11/identitymfatotp/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.21.0/docs/resources/identity_mfa_totp vault_identity_mfa_totp} Resource.
...
func IdentityMfaTotp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IdentityMfaTotp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
