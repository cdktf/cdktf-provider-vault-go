...
func (g *jsiiProxy_GcpAuthBackendCustomEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GcpAuthBackendCustomEndpointOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
