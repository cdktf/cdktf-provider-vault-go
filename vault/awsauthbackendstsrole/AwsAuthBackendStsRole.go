...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v12/awsauthbackendstsrole/internal"
...
func (j *jsiiProxy_AwsAuthBackendStsRole) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AwsAuthBackendStsRole) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AwsAuthBackendStsRole) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AwsAuthBackendStsRole) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AwsAuthBackendStsRole) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.23.0/docs/resources/aws_auth_backend_sts_role vault_aws_auth_backend_sts_role} Resource.
...
func (j *jsiiProxy_AwsAuthBackendStsRole)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AwsAuthBackendStsRole)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AwsAuthBackendStsRole)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AwsAuthBackendStsRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AwsAuthBackendStsRole) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AwsAuthBackendStsRole) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AwsAuthBackendStsRole) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
