...
import (
	...
	"github.com/hashicorp/cdktf-provider-vault-go/vault/v3/kvsecretv2/internal"
...
func (j *jsiiProxy_KvSecretV2) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_KvSecretV2)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
