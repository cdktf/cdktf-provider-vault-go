...
func (k *jsiiProxy_KvSecretV2CustomMetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KvSecretV2CustomMetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
