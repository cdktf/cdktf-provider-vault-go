...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v14/pkisecretbackendcrlconfig/internal"
...
func PkiSecretBackendCrlConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PkiSecretBackendCrlConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
