...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v12/identitymfaloginenforcement/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.23.0/docs/resources/identity_mfa_login_enforcement vault_identity_mfa_login_enforcement} Resource.
...
func IdentityMfaLoginEnforcement_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IdentityMfaLoginEnforcement) ImportFrom(id *string, provider cdktf.TerraformProvider) {
