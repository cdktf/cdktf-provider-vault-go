...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v5/identitymfaloginenforcement/internal"
...
func (j *jsiiProxy_IdentityMfaLoginEnforcement) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IdentityMfaLoginEnforcement)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
