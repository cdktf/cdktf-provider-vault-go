...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v12/datavaultgcpauthbackendrole/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.23.0/docs/data-sources/gcp_auth_backend_role vault_gcp_auth_backend_role} Data Source.
...
func DataVaultGcpAuthBackendRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
