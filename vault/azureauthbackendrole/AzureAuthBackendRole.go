...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v12/azureauthbackendrole/internal"
...
func (a *jsiiProxy_AzureAuthBackendRole) ImportFrom(id *string, provider cdktf.TerraformProvider) {
