...
import (
	...
	"github.com/hashicorp/cdktf-provider-vault-go/vault/v3/transformtransformation/internal"
...
func (j *jsiiProxy_TransformTransformation) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_TransformTransformation)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
