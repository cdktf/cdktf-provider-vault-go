...
import (
	...
	"github.com/hashicorp/cdktf-provider-vault-go/vault/v3/awsauthbackendroletagblacklist/internal"
...
func (j *jsiiProxy_AwsAuthBackendRoletagBlacklist) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
