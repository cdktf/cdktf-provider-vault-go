...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v12/kubernetessecretbackend/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.23.0/docs/resources/kubernetes_secret_backend vault_kubernetes_secret_backend} Resource.
...
func (k *jsiiProxy_KubernetesSecretBackend) ImportFrom(id *string, provider cdktf.TerraformProvider) {
