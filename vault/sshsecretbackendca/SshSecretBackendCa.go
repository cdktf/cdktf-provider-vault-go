...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v15/sshsecretbackendca/internal"
...
func (j *jsiiProxy_SshSecretBackendCa) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SshSecretBackendCa) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SshSecretBackendCa) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SshSecretBackendCa) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func SshSecretBackendCa_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SshSecretBackendCa) ImportFrom(id *string, provider cdktf.TerraformProvider) {
