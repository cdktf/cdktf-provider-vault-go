...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v11/awssecretbackendrole/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.23.0/docs/resources/aws_secret_backend_role vault_aws_secret_backend_role} Resource.
...
func (a *jsiiProxy_AwsSecretBackendRole) ImportFrom(id *string, provider cdktf.TerraformProvider) {
