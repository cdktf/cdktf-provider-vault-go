...
import (
	...
	"github.com/hashicorp/cdktf-provider-vault-go/vault/v3/awssecretbackendrole/internal"
...
func (j *jsiiProxy_AwsSecretBackendRole) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AwsSecretBackendRole)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
