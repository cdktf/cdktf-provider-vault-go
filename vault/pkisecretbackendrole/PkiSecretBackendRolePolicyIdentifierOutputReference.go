...
func (p *jsiiProxy_PkiSecretBackendRolePolicyIdentifierOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PkiSecretBackendRolePolicyIdentifierOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
