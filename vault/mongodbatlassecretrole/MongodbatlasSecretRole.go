...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v6/mongodbatlassecretrole/internal"
...
func (j *jsiiProxy_MongodbatlasSecretRole) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MongodbatlasSecretRole)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
