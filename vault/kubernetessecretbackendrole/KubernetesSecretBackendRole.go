...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v11/kubernetessecretbackendrole/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.23.0/docs/resources/kubernetes_secret_backend_role vault_kubernetes_secret_backend_role} Resource.
...
func KubernetesSecretBackendRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KubernetesSecretBackendRole) ImportFrom(id *string, provider cdktf.TerraformProvider) {
