...
func (s *jsiiProxy_SshSecretBackendRoleAllowedUserKeyConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SshSecretBackendRoleAllowedUserKeyConfigList) Resolve(context cdktf.IResolveContext) interface{} {
