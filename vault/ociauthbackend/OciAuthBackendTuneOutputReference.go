...
func (o *jsiiProxy_OciAuthBackendTuneOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OciAuthBackendTuneOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
