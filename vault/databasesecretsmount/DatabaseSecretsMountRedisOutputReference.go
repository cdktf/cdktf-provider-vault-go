...
func (d *jsiiProxy_DatabaseSecretsMountRedisOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatabaseSecretsMountRedisOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
