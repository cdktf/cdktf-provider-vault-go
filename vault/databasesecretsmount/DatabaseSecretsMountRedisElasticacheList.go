...
func (d *jsiiProxy_DatabaseSecretsMountRedisElasticacheList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DatabaseSecretsMountRedisElasticacheList) Resolve(context cdktf.IResolveContext) interface{} {
