...
import (
	...
	"github.com/hashicorp/cdktf-provider-vault-go/vault/v3/rgppolicy/internal"
...
func (j *jsiiProxy_RgpPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RgpPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
