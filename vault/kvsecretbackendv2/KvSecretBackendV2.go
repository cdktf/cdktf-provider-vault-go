...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v13/kvsecretbackendv2/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/4.7.0/docs/resources/kv_secret_backend_v2 vault_kv_secret_backend_v2} Resource.
...
func KvSecretBackendV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KvSecretBackendV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
