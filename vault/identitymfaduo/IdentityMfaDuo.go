...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v6/identitymfaduo/internal"
...
func (j *jsiiProxy_IdentityMfaDuo) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IdentityMfaDuo)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
