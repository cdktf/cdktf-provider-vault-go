...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v14/jwtauthbackend/internal"
...
func (j *jsiiProxy_JwtAuthBackendTuneList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_JwtAuthBackendTuneList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (j *jsiiProxy_JwtAuthBackendTuneList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JwtAuthBackendTuneList) Resolve(_context cdktf.IResolveContext) interface{} {
