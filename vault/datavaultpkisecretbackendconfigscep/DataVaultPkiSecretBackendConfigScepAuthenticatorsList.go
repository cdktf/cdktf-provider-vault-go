...
func (j *jsiiProxy_DataVaultPkiSecretBackendConfigScepAuthenticatorsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataVaultPkiSecretBackendConfigScepAuthenticatorsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataVaultPkiSecretBackendConfigScepAuthenticatorsList {
	_init_.Initialize()
...
func NewDataVaultPkiSecretBackendConfigScepAuthenticatorsList_Override(d DataVaultPkiSecretBackendConfigScepAuthenticatorsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataVaultPkiSecretBackendConfigScepAuthenticatorsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataVaultPkiSecretBackendConfigScepAuthenticatorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataVaultPkiSecretBackendConfigScepAuthenticatorsList) Resolve(_context cdktf.IResolveContext) interface{} {
