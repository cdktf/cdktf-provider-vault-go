...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v13/ldapauthbackendgroup/internal"
...
func LdapAuthBackendGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LdapAuthBackendGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
