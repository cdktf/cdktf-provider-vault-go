...
import (
	...
	"github.com/hashicorp/cdktf-provider-vault-go/vault/v3/awsauthbackendlogin/internal"
...
func (j *jsiiProxy_AwsAuthBackendLogin) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AwsAuthBackendLogin)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
