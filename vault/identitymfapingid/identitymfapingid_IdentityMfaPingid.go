...
import (
	...
	"github.com/cdktf/cdktf-provider-vault-go/vault/v3/identitymfapingid/internal"
...
func (j *jsiiProxy_IdentityMfaPingid) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IdentityMfaPingid)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
