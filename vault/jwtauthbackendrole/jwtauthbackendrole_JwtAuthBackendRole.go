...
import (
	...
	"github.com/hashicorp/cdktf-provider-vault-go/vault/v3/jwtauthbackendrole/internal"
...
func (j *jsiiProxy_JwtAuthBackendRole) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_JwtAuthBackendRole)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
